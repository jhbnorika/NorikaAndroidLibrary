...
package com.norika.android.library.bitmapfun.util;
...
public class ImageCache {
    ...
    public static class ImageCacheParams {
         ...
         * @param diskCacheDirectoryName A unique subdirectory name that will be
         *            appended to the application cache directory. Usually
