...
public abstract class ProgressFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.i_fragment_progress, container, false);
    }
    ...
    public void onErrorClick(View v) {
        if (statusTV.getVisibility() == View.VISIBLE || mIsError)
            onRefreshUI();
    }
    ...
    public void onDestroyView() {
        ...
        mIsError = false;
        mProgressContainer = mContentContainer = mContentView = mStatusView = null;
        super.onDestroyView();
    }
    ...
    /**
     * The default content for a ProgressFragment has a TextView that can be
     * shown when the content is empty {@link #setContentEmpty(boolean)} or an
     * error occurred. If you would like to have it shown, call this method to
     * supply the text it should use.
     * 
     * @param text Text for empty view or error view
     * @see #setStatusText(int)
     */
    public void setStatusText(CharSequence text) {
        ensureContent();
        if (statusTV != null && statusTV instanceof TextView) {
    ...
    public void setStatusBackground(int top, int bottom) {
        statusTV.setVisibility(View.GONE);
        topIV.setVisibility(View.VISIBLE);
        bottomIV.setVisibility(View.VISIBLE);
        topIV.setImageResource(top);
        bottomIV.setImageResource(bottom);
    }
     ...
     * @see #isContentEmpty()
     */
    public void setContentStatus(DataStatus dataStatus) {
        ensureContent();
        if (mContentView == null) {
            throw new IllegalStateException("Content view must be initialized before");
        }
        if (dataStatus == null)
            throw new IllegalStateException("Data Type must be valid, not null");
    ...
    private void ensureContent() {
        ...
        progressTV = (TextView) mProgressContainer.findViewById(R.id.progress_text);
        ...
        mStatusView = root.findViewById(android.R.id.empty);
        if (mStatusView != null) {
            statusTV = (TextView) mStatusView.findViewById(R.id.empty_tv);
            bottomIV = (ImageView) mStatusView.findViewById(R.id.bottom_iv);
            topIV = (ImageView) mStatusView.findViewById(R.id.top_iv);
            mStatusView.setVisibility(View.GONE);
        }
        mContentShown = true;
